...
//    }
    ...
    @PutMapping("/users")
    public ResponseEntity<User> /*ResponseEntity<User>*/ updateUser(/*@PathVariable("id") Long id,*/ @RequestBody User user/*, @RequestParam("nameRoles") Long[] rolesId*/) {
//        HashSet<Role> roles = new HashSet<>();
//        for(Long roleId : rolesId) {
//            roles.add(roleService.show(roleId));
//            roleService.save(roleService.show(roleId));
//        }
//
//        user.setRoles(roles);
